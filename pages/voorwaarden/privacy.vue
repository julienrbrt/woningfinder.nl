<template>
  <Hero>
    ...
    <div class="text-gray-700">
      ...
      <p>
        WoningFinder B.V. verwerkt je persoonsgegevens doordat je gebruik maakt
      ...
      <ul>
        ...
        <li>
          ...
          profiel op deze website aan te maken, en in correspondentie
        </li>
      ...
      <p>
        ...
        ons op via
        <span class="underline">contact@woningfinder.nl</span>, dan verwijderen
        wij deze informatie.
      </p>
      ...
      <ul>
        ...
        <li>Verzenden van onze wekelijkse e-mail update</li>
        <li>
          Je te kunnen e-mailen indien dit nodig is om onze dienstverlening uit
          te kunnen voeren
        </li>
        <li>Je te informeren over wijzigingen van onze diensten</li>
        <li>
          Je de mogelijkheid te bieden een account / zoekopdracht aan te maken
        </li>
        <li>Om ons diensten bij je af te leveren</li>
      </ul>
      ...
      <p>
        WoningFinder B.V. gebruikt alleen technische en functionele cookies. En
      ...
      <p>
        ...
        <span class="underline">contact@woningfinder.nl</span>. Om er zeker van
        ...
        mogelijk, maar binnen vier weken, op jouw verzoek . WoningFinder B.V.
        ...
        <a
          class="text-gray-900"
          href="https://autoriteitpersoonsgegevens.nl/nl/contact-met-de-
          autoriteit-persoonsgegevens/tip-ons"
          >https://autoriteitpersoonsgegevens.nl/nl/contact-met-de-
          autoriteit-persoonsgegevens/tip-ons</a
        >
      </p>
