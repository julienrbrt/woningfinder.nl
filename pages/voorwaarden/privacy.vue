      ...
      <div class="text-gray-700">
        ...
        <ul>
          ...
          <li>
            ...
            een profiel op deze website aan te maken, en in correspondentie
          </li>
        ...
        <p>
          ...
          <span class="underline">contact@woningfinder.nl</span>, dan
        ...
        <ul>
          ...
          <li>
            Je te kunnen e-mailen indien dit nodig is om onze dienstverlening
        ...
        <p>
          ...
          De bewaartermijn hangt af van hoe snel we een woning voor jou vinden.
        </p>
        ...
        <p>
          ...
          Maak in deze kopie je pasfoto, MRZ (machine readable zone, de strook
