    ...
    return {
      qa: [
        ...
        },
        {
          ...
          answer:
            'Allereerst, gefeliciteerd! Je betaalt WoningFinder alleen één keer voor één zoekopdracht, dus je hoeft niets te annuleren. Je kan zelf je account verwijderen via je account.',
        },
        {
